...
SimpleDash.prototype.initialize = function () {
    ...
    this.leftBlink.html('<svg><path d="m 1.5,16.5 16.416,15 0,-7.053 13.584,0 0,-15.894 -13.584,0 0,-7.053 -16.416,15 z" id="blink_left" style="fill:#000000;fill-opacity:0.5" /></svg>');

    this.rightBlink.html('<svg><path d="m 31.498,16.5 -16.416,15 0,-7.053 -13.584,0 0,-15.894 13.584,0 0,-7.053 16.42,15 z" id="blink_right" style="fill:#000000;fill-opacity:0.5"/></svg>');
