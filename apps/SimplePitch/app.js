function SimplePitch() {}

SimplePitch.prototype.initialize = function () {
    ...
    this.pitchIco.src = this.path + 'pitchIco.svg';

};

SimplePitch.prototype.toggledisplaySide = function(){
...
SimplePitch.prototype.update = function (streams) {

    var pitch = Math.asin(streams.sensors.pitch);
    ...
    ctx.fillText((pitch / Math.PI * 180).toFixed(1) + "\u00B0", 256, 480);

    ctx.fillText("Pitch", 256, 32);
...
SimplePitch.prototype.resize = function(){
