    ...
    data = {
        ...
        childs: {
            ...
            postFxManager: {
                        ...
                        childs: {
                            ...
                            effects: {
                                ...
                                childs: {
                                    ...
                                    color:{name:'Color',type:'color',val:'255 0 0', onChange:onTSChangeDirect, tsCb:"Settings_PostFX_HDR_Effects_color_shift"},
                ...
                //     revert:{name:'Revert',type:'button',clearChanges: true,cmdJs:'',cmdTs:'',cmdLua:[], paramLua:[]},
